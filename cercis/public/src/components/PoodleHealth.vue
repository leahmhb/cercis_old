<template>
<div id="health">
<article v-if=!showHealthForm class="mt-2">
  <div class="row">
    <div class="col">
...
<article v-if="showHealthForm">
  <form id="health-form" ref="health-form" method="post" @submit.prevent="changePoodle('health-form')">
    <b-form-row>
      <b-col>
...
<div class="mt-4 mb-0 d-flex flex-row justify-content-between align-items-end">
  <b-button variant="outline-info" @click="showHealthForm=!showHealthForm">
    <i v-if="showHealthForm" class="fas fa-toggle-off"></i>
    <i v-if="!showHealthForm" class="fas fa-toggle-on"></i> Update
  </b-button>
  <b-btn-group v-if="showHealthForm">
    <b-button variant="outline-secondary" type="reset">
      <i class="fas fa-eraser"></i> Reset
    </b-button>
    <b-button variant="success" type="subit" @click="changePoodle('health-form')">
